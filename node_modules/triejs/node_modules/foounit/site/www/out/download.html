...
<p>
  Get the browser version (no npm install necessary): <a href="downloads/foounit-$version-browser.tar.bz2">foounit-$version-browser.tar.bz2</a><br>
...
<p>
  Get the <a href="https://github.com/foobarfighter/foounit">source</a>.
</p>
...
<!-- /Download -->
    ...
    <div class="content footer" style="text-align: center">
      Site designed by <a href="http://jeejkang.com">James Kang</a> and <a href="http://heatherkphillips.com">Heather Phillips</a>
    </div>

    <script type="text/javascript">
    var _gaq = _gaq || [];
    _gaq.push(['_setAccount', 'UA-24092210-1']);
